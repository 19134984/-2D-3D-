...
mpirun -np 1 -x UCX_MEMTYPE_CACHE=n -x UCX_RNDV_THRESH=8192 -x LD_LIBRARY_PATH  -mca pml ucx --mca btl ^vader,tcp,openib,uct --mca plm_rsh_agent /opt/batch/agent/tools/dstart ./a.out  2>&1
