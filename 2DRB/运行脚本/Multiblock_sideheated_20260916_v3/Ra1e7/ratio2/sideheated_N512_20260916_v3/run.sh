#!/bin/bash
set -eu
CASE=/data2/XLLi/Multiblock/Ra1e7/ratio2/sideheated_N512_20260916_v3
...
test "$(cut -d ' ' -f1 runtime_source.sha256)" = '90e5702cea5255daade80cd9bed0afce1fb2f0c688e59d71a869b5a252d08c8e'
