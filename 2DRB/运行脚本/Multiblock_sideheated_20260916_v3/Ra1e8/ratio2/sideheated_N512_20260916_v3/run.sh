#!/bin/bash
set -eu
CASE=/data2/XLLi/Multiblock/Ra1e8/ratio2/sideheated_N512_20260916_v3
...
test "$(cut -d ' ' -f1 runtime_source.sha256)" = '905a764abb8bec99eb218d678e97456328cb98192ff41b45420ac7e5c5a3bc30'
