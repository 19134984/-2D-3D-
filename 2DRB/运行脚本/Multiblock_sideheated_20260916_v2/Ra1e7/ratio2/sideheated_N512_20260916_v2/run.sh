#!/bin/bash
set -eu
CASE=/data2/XLLi/Multiblock/Ra1e7/ratio2/sideheated_N512_20260916_v2
...
test "$(cut -d ' ' -f1 runtime_source.sha256)" = '3ec302a8e1102331a1f4833248604d5881330d9bf36644f370519a69d59c9b73'
