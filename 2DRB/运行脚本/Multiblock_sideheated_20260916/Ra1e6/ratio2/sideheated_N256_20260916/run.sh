#!/bin/bash
set -eu
CASE=/data2/XLLi/Multiblock/Ra1e6/ratio2/sideheated_N256_20260916
...
test "$(cut -d ' ' -f1 compiled_source.sha256)" = 'e31b2d317b901a481c647c65d249ea818a31b974d9a0726b181a5942e0671114'
