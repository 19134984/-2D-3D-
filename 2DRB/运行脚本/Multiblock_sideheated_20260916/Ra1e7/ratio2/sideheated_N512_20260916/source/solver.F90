...
!   全局模块
    module commondata
        ...
        integer(kind=4), parameter :: nx = 512, ny = 512    ! 手动设置最细网格等效分辨率，修改后重新编译
        integer(kind=4), parameter :: refineRatio = 2    ! 粗/细格距及时间步之比；逐级二分取2、4、8等2的幂，1为单块
        integer(kind=4), parameter :: fineLayerCellsLeft = 64      ! 从左墙向内数的细节点编号，x = Left-0.5
        integer(kind=4), parameter :: fineLayerCellsRight = 65     ! 从右墙向内数的细节点编号，x = nx-Right+0.5
        integer(kind=4), parameter :: fineLayerCellsBottom = 64    ! 从下墙向内数的细节点编号，y = Bottom-0.5
        integer(kind=4), parameter :: fineLayerCellsTop = 65       ! 从上墙向内数的细节点编号，y = ny-Top+0.5
